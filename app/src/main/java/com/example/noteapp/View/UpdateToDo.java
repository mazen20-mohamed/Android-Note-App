...
public class UpdateToDo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String body = intent.getStringExtra("alarmDate");

        EditText editText = findViewById(R.id.title_update2);
        EditText des = findViewById(R.id.description_update2);
        editText.setText(title);
        String id = intent.getStringExtra("id");
        des.setText(body);
        SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(this);
        String token =sharedPreferences.getString("token","default");
        Button btn = findViewById(R.id.elevatedButton5);
        ...
        MaterialToolbar topAppBar = findViewById(R.id.top);
